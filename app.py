...
def write_all_schedules(schedules):
    with open(SCHEDULES_FILE, 'w', encoding='utf-8') as f:
        for s in schedules:
            # Añadimos el estado (status) al final de la línea. Por defecto será 'pendiente'.
...
def coordinator_dashboard():
    ...
    # Ya no enviamos "teachers" ni "subjects" porque se eliminó el formulario de asignación
